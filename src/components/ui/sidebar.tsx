...
function SidebarProvider({
  ...
  // Use defaultOpen directly - server reads cookie and passes it as prop
  ...
  const toggleSidebar = React.useCallback(() => {
    ...
    // Mark that user has manually toggled to respect their preference
    setUserToggled(true);
  ...
  const contextValue = React.useMemo<SidebarContextProps>(
    ...
    [state, open, setOpen, isMobile, isHydrated, openMobile, toggleSidebar],
  );
...
function Sidebar({
  ...
  // Since we read from cookies server-side, use the actual state directly
